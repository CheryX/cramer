...
export default function Question({ children: explanation, title, answers=['Prawda', 'Fałsz'], correct }) {
	...
	return (
		<div className="my-10 p-5 lg:p-10 lg:px-20 border-primary-600 dark:border-primary-300 border print:hidden">
