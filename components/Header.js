...
export default function Header({page, searchOptions}) {
	...
	return (
		<header className="z-50 dark:text-white p-3 print:hidden border-b border-b-primary-200 dark:border-b-primary-700 sticky top-0 bg-primary-100/70 dark:bg-primary-900/70">
