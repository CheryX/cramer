    ...
    return (
        <>
            <div className={visible + " fixed bottom-4 w-full lg:left-1/4 lg:w-1/2 bg-slate-500/50 p-2 rounded-xl backdrop-blur flex align-center z-50"}>
                <button className="bg-teal-600 px-8 py-2 rounded-xl text-white font-bold" onClick={() => {setVisible("hidden"); setCookie('dont_show', true, { maxAge: 60 * 60 * 24 * 60 })}}>OK</button>
