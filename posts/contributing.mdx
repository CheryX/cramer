---
title: Dodawanie własnej notatki
summary: Poradnik jak napisać własną notatkę, a nastęnie ją dodać
date: '2022-06-22'
authors: ['cheryx']
hidden: true
---
...
Jeśli masz już gotowy plik `.mdx`, to na [repozytorium projektu](https://github.com/CheryX/notes) wejdź w folder `/posts`, i dodaj nowy plik używając guziku *Add File*.
