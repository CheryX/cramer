...
authors: [cheryx]
excerpt: 'Pomoc do znalezienia rodzaju rzeczownika'
...
Jest spora szansa że podczas sprawdzianu zapomnisz który rodzaj pasuje do którego słowa, możesz zawsze spróbować uratować pare punktów stosując się do tych (prawie) ogólnych zasad.[^1]

> Lepiej się uczyć rodzaju razem z rzeczownikiem, tego lepiej używaj jako ostatnią deske ratunku
